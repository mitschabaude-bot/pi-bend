...
The [full gate](proof-validation/2026-09-21-default-session.json) checks 448 public laws and 67 supporting lemmas and rejects 243 typed mutations. It includes the two pricing-owner laws and three session-composition laws: grammar preservation, installation of owned pricing, and pricing retirement before supplied dependencies. [Runtime formatting and ownership](openai-responses-renderer-context.md) have separate finite evidence. The twenty existing unsafe declarations still produce twenty-two concrete checker annotations. The [subsequent hook-adapter gate](proof-validation/2026-09-21-provider-hook-map.json) passes with 455 public laws, 67 supporting lemmas and 246 rejected typed mutations. Its seven additional generic contracts cover success/error mapping, borrowed ownership and adapter retirement, with three mutations exercising dropped hooks and skipped disposal.
