...
Decimal-to-binary64 parsing, complete JSON serialization and schema metadata handling remain pending. The bootstrap JSON encoder's preserved decimal tokens still cannot replace the canonical codec or establish correct tool-declaration comparison.
