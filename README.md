...
Canonical library tests currently use Bend 2.0.5 with the explicit [compiler patches](patches/README.md) for shared imports and channel identity. Their pure build path does not link the bootstrap's libcurl/ICU adapters.
