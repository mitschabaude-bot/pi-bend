...
Validated so far: pre-wait and parked cancellation, competing/repeated cancels, stale capabilities across slot reuse, unstarted release, successful packets, invalid receive limits and subsequent socket use. Native fixture audits check live operation rows, channels, queued waits and sockets. Packet-arrival races, timer/abort integration, send cancellation, performance comparison and broader resource stress remain before adoption.
