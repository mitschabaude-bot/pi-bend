...
assert unsafe_declarations == {
    ...
    ('packages/runtime/src/http-response.bend', 'driveResponseReader'),
    ('packages/runtime/src/tls-socket.bend', 'handshakeLoop'),
    ('packages/runtime/src/tls-socket.bend', 'readLoop'),
    ('packages/runtime/src/tls-socket.bend', 'writeLoop'),
    ('packages/runtime/src/sse.bend', 'drive'),
    ('packages/runtime/src/dns-message.bend', 'drive'),
    ('packages/runtime/src/dns-resolver.bend', 'drive'),
