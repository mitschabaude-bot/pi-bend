"""Compare isolated timer additions with the installed compiler.

Usage: python3 scripts/benchmark-timer.py CANDIDATE_BEND2 OUTPUT_JSON
Measures loading/checking/C emission, not Clang, timer operations or runtime throughput.
"""
import hashlib
import json
...
with tempfile.TemporaryDirectory(prefix='timer-perf-', dir=ROOT / 'build') as directory:
    folder = Path(directory)
    for source in ['tests/runtime-detached-sleep.bend', 'packages/runtime/test/utf8-runner.bend']:
