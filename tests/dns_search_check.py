...
subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'clang','-std=c11','-fbracket-depth=2048','-O1','build/dns-search.c','-lpthread','-lm','-o','build/dns-search'],cwd=ROOT,check=True)
