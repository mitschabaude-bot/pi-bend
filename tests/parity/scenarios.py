...
SCENARIOS = [
    ...
    {
        "name": "resume-scopes", "args": MODEL + ["--session-dir", "sessions"],
        "turns": [{"text": "Before resume scopes."}, {"text": "After resume scopes."}],
        "files": {"project/sessions/older.jsonl": '{"type":"session","version":3,"id":"older","timestamp":"2025-01-01T00:00:00Z","cwd":"<root>/other-project"}\n{"type":"session_info","id":"older-name","parentId":null,"timestamp":"2025-01-01T00:00:01Z","name":"Older session"}\n',
                  "home/.pi/agent/keybindings.json": json.dumps({"app.session.resume": "ctrl+e"})},
        "steps": [("wait", READY, "startup"), ("settle", 0.3), ("keys", "hello scopes"), ("key", "Enter"),
                  ("wait", "Before resume scopes.", "answer"), ("settle", 0.3),
                  ("keys", "preserved scope draft"), ("key", "C-e"), ("wait", "Resume Session", "picker"),
                  ("settle", 0.3), ("snap", "current"),
                  ("key", "Tab"), ("wait", r"Resume Session \(All\)", "all"), ("settle", 0.3), ("snap", "all"),
                  ("key", "Down"), ("keys", "Older"), ("key", "Tab"), ("key", "Tab"),
                  ("settle", 0.3), ("snap", "filtered"), ("key", "Escape"), ("settle", 0.3), ("snap", "draft"),
                  ("key", "C-e"), ("wait", "Resume Session", "reopened"), ("key", "Tab"),
                  ("settle", 0.3), ("snap", "reopened"), ("key", "Escape"), ("settle", 0.3), ("snap", "closed-again"),
                  ("key", "Enter"), ("wait", "After resume scopes.", "following"), ("settle", 0.3), ("snap", "following")],
    },
    {
        "name": "resume-mutations", "args": MODEL + ["--session-dir", "sessions"],
        "turns": [{"text": "Before resume mutations."}, {"text": "After resume mutations."}],
        "files": {"project/sessions/target.jsonl": '{"type":"session","version":3,"id":"target","timestamp":"2025-01-01T00:00:00Z","cwd":"<root>/project"}\n{"type":"session_info","id":"target-name","parentId":null,"timestamp":"2025-01-01T00:00:01Z","name":"Original shared name"}\n',
                  "home/.pi/agent/keybindings.json": json.dumps({"app.session.resume": "ctrl+e"})},
        "steps": [("wait", READY, "startup"), ("settle", 0.3), ("keys", "hello mutations"), ("key", "Enter"),
                  ("wait", "Before resume mutations.", "answer"), ("settle", 0.3),
                  ("keys", "preserved mutation draft"), ("key", "C-e"), ("wait", "Resume Session", "picker"),
                  ("settle", 0.3), ("key", "Tab"), ("settle", 0.3), ("snap", "cached-all"),
                  ("keys", "Original shared"), ("key", "C-r"), ("wait", "Rename Session", "rename"),
                  ("key", "End"), ("key", "C-u"), ("keys", "Renamed shared name"), ("key", "Enter"),
                  ("wait", "Resume Session", "saved"), ("key", "C-u"), ("keys", "Renamed shared"),
                  ("wait", "Renamed shared name", "renamed-all"), ("settle", 0.3), ("snap", "renamed-all"),
                  ("key", "Tab"), ("wait", "Renamed shared name", "renamed-current"), ("settle", 0.3), ("snap", "renamed-current"),
                  ("key", "Tab"), ("settle", 0.3), ("key", "C-d"), ("wait", "Delete session", "confirm"),
                  ("key", "Enter"), ("wait", "Session deleted|Session moved to trash", "deleted"), ("settle", 0.3), ("snap", "deleted-all"),
                  ("key", "Tab"), ("wait", "◉ Current Folder", "deleted-current"), ("settle", 0.3), ("snap", "deleted-current"),
                  ("key", "Escape"), ("settle", 0.3), ("snap", "draft"),
                  ("key", "Enter"), ("wait", "After resume mutations.", "following"), ("settle", 0.3), ("snap", "following")],
    },
    {
        "name": "resume-rename",
        "args": MODEL,
    ...
    },
    {
        ...
        "turns": [{"text": "After login cancellation."}],
        "steps": [("wait", READY, "startup"), ("settle", 0.3),
                  ("keys", "/login"), ("key", "Enter"), ("wait", "Select authentication method:", "method"),
                  ("settle", 0.2), ("snap", "method"),
                  ("key", "Down"), ("key", "Enter"), ("wait", "Select provider to configure:", "providers"),
                  ("keys", "OpenAI"), ("settle", 0.2), ("snap", "providers"), ("key", "Escape"),
                  ("wait", "Select authentication method:", "back"), ("settle", 0.2), ("snap", "back"),
                  ("key", "Escape"), ("settle", 0.3), ("snap", "cancelled"),
                  ("keys", "after login cancellation"), ("key", "Enter"),
                  ("wait", "After login cancellation.", "following"), ("settle", 0.3), ("snap", "following")],
    },
    {
