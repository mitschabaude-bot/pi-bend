...
subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'clang','-std=c11','-fbracket-depth=2048','-O1','build/connection-order.c','-lpthread','-lm','-o','build/connection-order'],cwd=ROOT,check=True)
