...
const hashes={"packages/tui/src/utils.ts":"014e017a0cb45d8f4e07af6e472c282c6dec7c5856a335a3e3beeb6054f385d3","packages/tui/src/components/editor.ts":"88076036a3ff33da05f347101a6ab56749c8be398d7a35dea1976e62230c4ac5"};
...
const u=new Function('eastAsianWidth',utils+';return {visibleWidth,cjkBreakRegex,isWhitespaceChar,getGraphemeSegmenter,getWordSegmenter}')(eastAsianWidth);
