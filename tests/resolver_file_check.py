...
subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'clang','-std=c11','-fbracket-depth=2048','-O1','build/resolver-file-audit.c','-lpthread','-lm','-o','build/resolver-file'],cwd=ROOT,check=True)
