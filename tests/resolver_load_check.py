...
paths=['packages/runtime/src/resolver-load.bend','packages/runtime/src/resolver-environment.bend','packages/runtime/src/resolver-file.bend','tests/resolver-load.bend','tests/resolver_load_check.py']
