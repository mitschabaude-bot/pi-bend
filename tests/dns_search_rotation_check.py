...
paths=['packages/runtime/src/dns-server-source.bend','packages/runtime/src/dns-server-rotation.bend','packages/runtime/src/dns-address-search.bend','packages/runtime/src/dns-address-lookup.bend','packages/runtime/src/dns-tcp-servers.bend','packages/runtime/src/dns-tcp-recover.bend','tests/dns-search-rotation.bend','tests/dns_search_rotation_check.py','tests/dns-lookup-ids.bend','tests/dns-address-lookup.bend','tests/dns-tcp-servers.bend','build/dns-search-rotation','build/dns-search-rotation.js']
