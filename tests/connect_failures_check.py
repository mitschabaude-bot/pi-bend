...
subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'clang','-fbracket-depth=2048','-std=c11','-O1','build/connect-failures.c','-lpthread','-lm','-o','build/connect-failures'],cwd=ROOT,check=True,timeout=60)
rows=[]
