...
subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'clang','-std=c11','-fbracket-depth=2048','-O1','build/dns-resolver-owner-audit.c','-lpthread','-lm','-o','build/dns-resolver-owner'],cwd=ROOT,check=True)
