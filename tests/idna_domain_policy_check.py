...
if '--no-build' not in sys.argv:
    subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'sh','scripts/build-pure.sh','packages/runtime/test/idna-domain-policy.bend','build/idna-domain-policy'],cwd=ROOT,check=True)
