...
const u=new Function('eastAsianWidth',utils+';return {visibleWidth,cjkBreakRegex,isWhitespaceChar,getGraphemeSegmenter,getWordSegmenter,sliceByColumn,PUNCTUATION_REGEX}')(eastAsianWidth);
