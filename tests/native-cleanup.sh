...
for suite in record_vectors constrained_sampling_vectors tool_declaration_vectors tool_state_vectors tool_history_vectors model_types model_metadata_vectors model_cost_vectors agent_types provider_option_types loop_config_types tool_preparation_types tool_result_message tool_batch_vectors tool_selection_vectors before_tool_decision_vectors turn_update_vectors tool_result_vectors validation_primitives_vectors primitive_coercion_vectors schema_type_coercion_vectors schema_check unique_items_check schema_convert_check schema_container_check schema_builder_check uri_component_check schema_references_check normalization_check recursive_coercion_check plain_validation_check validation_errors_check; do
