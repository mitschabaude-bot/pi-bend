...
if __name__=='__main__':
 ...
 long=[dict(method='wrapTextWithAnsi',text='word ',repeat=10000,width=80),dict(method='sliceWithWidth',text='界x',repeat=100000,start=299990,length=10,strict=True),dict(method='extractSegments',text='x',repeat=200000,before=10,after=199990,length=10,strict=True)]
 assert batch(command,long)==batch(oracle,long)
 print('Three long wrapping/slicing/overlay scans passed',flush=True)
 corrected=[
