...
const { DefaultPackageManager } = await import(UPSTREAM + "/packages/coding-agent/src/core/package-manager.ts");
const { SettingsManager } = await import(UPSTREAM + "/packages/coding-agent/src/core/settings-manager.ts");
