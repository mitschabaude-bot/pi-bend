...
paths=['packages/runtime/src/random-index.bend','packages/runtime/src/dns-server-initialize.bend', 'packages/runtime/src/dns-server-source.bend','packages/runtime/src/dns-server-rotation.bend','tests/dns_server_initialize_check.py']+[f'tests/{f}.bend' for f in fixtures]
