...
lines=['import Base','import ../packages/runtime/src/schema-builder.bend as D','import ../packages/runtime/src/schema-value.bend as V','import ../packages/runtime/src/record.bend as R','import ../packages/runtime/test/schema-convert.bend as T','def main() -> IO(Unit):','  do IO<Unit>:']
