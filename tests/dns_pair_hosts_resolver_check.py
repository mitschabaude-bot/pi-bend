...
subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'clang','-std=c11','-fbracket-depth=2048','-O1','build/dns-pair-hosts-resolver-audit.c','-lpthread','-lm','-o','build/dns-pair-hosts-resolver'],cwd=ROOT,check=True)
