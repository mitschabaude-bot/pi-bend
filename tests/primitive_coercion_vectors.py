...
import random
import subprocess
from schema_test_values import bend
ROOT=Path(__file__).resolve().parents[1]
BUILD=ROOT/'build'
BUILD.mkdir(exist_ok=True)
kinds=['number','integer','boolean','string','null','object','array','unknown','','Number']
values=[['undefined'],['null'],['boolean',False],['boolean',True],['symbol',3],['callable',4],['bigint'],['array',[]],['array',[['null'],['undefined']]],['object',[['hidden',['callable',9],False],['a',['number','8000000000000000'],True]],[[1,['undefined']]]]]
