...
subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'clang','-std=c11','-fbracket-depth=2048','-O1','build/resolver-config.c','-lpthread','-lm','-o','build/resolver-config'],cwd=ROOT,check=True)
