"""Input/SettingsList integration with decoded native ICU rule/CJK/Khmer assets."""
...
for text,language in [('ภาษา','Thai'),('မြန်မာ','Myanmar'),('ພາສາ','Lao')]:
...
for backend in a.backends:
 ...
 print(f'{backend}: {len(expected)} loaded-context Input/SettingsList sequences pass (CJK, Khmer, Latin, deterministic Common marks, three missing engines)',flush=True)
