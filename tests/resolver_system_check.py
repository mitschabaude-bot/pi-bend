...
subprocess.run(['flock', '/tmp/pi-bend-build.lock', 'clang','-std=c11','-fbracket-depth=2048','-O1','build/resolver-system-audit.c','-lpthread','-lm','-o','build/resolver-system'],cwd=ROOT,check=True)
...
paths=['packages/runtime/src/resolver-config.bend','packages/runtime/src/resolver-config.bend','tests/resolver-system.bend','tests/resolver_system_check.py']
